                    ...
                    <table id="datos" class="table text-center table-bordered border-dark table-hover table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr >
                                ...
                                <td>
                                    <div>
                                        <button data-id="<%=dpVO.getId_Detalles_Producto()%>" data-id2="<%=dpVO.getId_Detalles_Producto()%>"  class="btn boton mt-2 detalles">
                                        ...
                                        <button data-id3="<%=dpVO.getId_Detalles_Producto()%>" data-id4="<%=dpVO.getId_Detalles_Producto()%>"  class="btn boton mt-2 eliminar">
